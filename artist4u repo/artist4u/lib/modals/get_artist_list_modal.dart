...
//
//     final getArtistListl = getArtistListlFromJson(jsonString);

import 'dart:convert';

GetArtistListl getArtistListModalFromJson(String str) => GetArtistListl.fromJson(json.decode(str));

String getArtistListlToJson(GetArtistListl data) => json.encode(data.toJson());

class GetArtistListl {
    GetArtistListl({
        this.result,
    });
    ...
    factory GetArtistListl.fromJson(Map<String, dynamic> json) => GetArtistListl(
